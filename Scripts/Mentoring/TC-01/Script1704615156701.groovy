...
WebUI.setEncryptedText(findTestObject('Object Repository/Page_Masuk  MySkill/input_password'), 'E4paS9pRTYmXuQbOOhuSug==')

WebUI.sendKeys(findTestObject('Object Repository/Page_Masuk  MySkill/input_password'), Keys.chord(Keys.ENTER))

WebUI.click(findTestObject('Object Repository/Page_Si Paling Belajar  MySkill/a_Mentoring'))

WebUI.click(findTestObject('Object Repository/Page_Mentoring Review  MySkill/a_Daftar Sekarang'))

WebUI.click(findTestObject('Object Repository/Page_Payment  MySkill/button_Pilih Metode Pembayaran'))

WebUI.click(findTestObject('Object Repository/Page_Payment  MySkill/span_ShopeePay  SPayLater'))
...
WebUI.click(findTestObject('Object Repository/Page_Checkout - 20240107-XD-32060000000497/button_Download QR Code'))
