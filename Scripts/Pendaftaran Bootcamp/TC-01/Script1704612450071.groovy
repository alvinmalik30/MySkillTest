...
WebUI.setText(findTestObject('Object Repository/Page_DIGITAL MARKETING FULLSTACK INTENSIVE _e4d593/input_name'), 'Alvin Malik')

WebUI.setText(findTestObject('Object Repository/Page_DIGITAL MARKETING FULLSTACK INTENSIVE _e4d593/input_phone'), '0893467436823')

WebUI.setText(findTestObject('Object Repository/Page_DIGITAL MARKETING FULLSTACK INTENSIVE _e4d593/input_currentWork'), 
    '')

WebUI.click(findTestObject('Object Repository/Page_DIGITAL MARKETING FULLSTACK INTENSIVE _e4d593/input_currentWork'))

WebUI.click(findTestObject('Object Repository/Page_DIGITAL MARKETING FULLSTACK INTENSIVE _e4d593/li_Mahasiswa'))

WebUI.click(findTestObject('Object Repository/Page_DIGITAL MARKETING FULLSTACK INTENSIVE _e4d593/input_referral'))

WebUI.click(findTestObject('Object Repository/Page_DIGITAL MARKETING FULLSTACK INTENSIVE _e4d593/li_Instagram Ads'))
...
WebUI.click(findTestObject('Object Repository/Page_Payment  MySkill/div_GoPay'))
...
WebUI.setText(findTestObject('Object Repository/Page_Payment  MySkill/input_name'), 'Alvin Malik')

WebUI.setText(findTestObject('Object Repository/Page_Payment  MySkill/input_phone'), '089346743682323')

WebUI.click(findTestObject('Object Repository/Page_Payment  MySkill/button_Perbarui Profil'))
