...
WebUI.click(findTestObject('Object Repository/Page_Bootcamp  Program  MySkill/div_A'))

WebUI.click(findTestObject('Object Repository/Page_Bootcamp  Program  MySkill/a_Profil'))

WebUI.click(findTestObject('Object Repository/Page_Profile Saya  MySkill/span_Riwayat Transaksi'))

WebUI.click(findTestObject('Object Repository/Page_Transaksi Saya  MySkill/a_Lihat Detail'))
